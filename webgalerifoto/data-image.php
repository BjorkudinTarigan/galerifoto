...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <p><a type="button" class="btn btn-success" href="tambah-image.php" ">Tambah Data</a></p><br>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-success" href="edit-image.php?id=<?php echo $row['image_id'] ?>">Edit</a> <br><br>
                                        <a type="button" class="btn btn-success" href="proses-hapus.php?idp=<?php echo $row['image_id'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php }
                        } else { ?>
